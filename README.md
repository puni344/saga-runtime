...
- **259 tests** across runtime / payment-domain / webhook / AI / adversarial / process-restart / contract / scorecard / security-hardening suites (one `node --test tests/*.test.js` run, zero failures)
